...
urlpatterns = [
    ...
    path("password-reset/<uidb64>/<token>", view=PasswordResetConfirmView.as_view(template_name="accounts/password_reset_confirm.html", form_class=CustomSetPasswordForm), name="password_reset_confirm"),
    path("password-reset/complete", view=PasswordResetCompleteView.as_view(template_name="accounts/password_reset_complete.html"), name="password_reset_complete"),
    
    path("password-change", view=PasswordChangeView.as_view(template_name="accounts/password_change.html", form_class=CustomPasswordChangeForm), name="password_change"),
    path("password-change/done", view=PasswordChangeDoneView.as_view(template_name="accounts/password_change_done.html"), name="password_change_done"),
]
